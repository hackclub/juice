...
export default function FirstChallengeWindow({
  position,
  isDragging,
  isActive,
  handleMouseDown,
  ...
  const handleSubmitPR = async () => {
    ...
    try {
      ...
      document
        .querySelector('div[data-shake-container="true"]')
        ?.style.setProperty(
          "animation",
  ...
  const hasPRSubmitted =
    userData?.achievements?.includes("pr_submitted") || isSuccess;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ width: 200, height: 282.84 }}>
            {" "}
            {/* A4 proportions container (200 * 1.4142) */}
            <canvas
              ref={canvasRef}
              style={{
                width: "100%",
          ...
          <p>
            Your first challenge, should you choose to accept it, is to come up
            with your idea & add it to Juice repo games folder.
          </p>
          <ol>
            <li>
              write your idea in a markdown file{" "}
              <a
                target="_blank"
                href="https://github.com/hackclub/juice/blob/main/games/template/README.md"
              >
                (template)
              </a>
            </li>
            <li>
              open a PR to the{" "}
              <a target="_blank" href="https://github.com/hackclub/juice">
                Juice repo
              </a>{" "}
              & add your idea{" "}
              <a
                target="_blank"
                href="https://youtu.be/7O4qYoWU54M?si=kyA3mdGAJMZnBbZe"
              >
                (guide)
              </a>
            </li>
          ...
          <p>
            ...
            <a
              target="_blank"
              href="https://github.com/hackclub/juice/tree/main/games/mountainVille"
            >
              the markdown file that Paolo & I made for our game
            </a>
            .
          </p>
          <div>
          ...
          {hasPRSubmitted && (
            <p style={{ color: "green", margin: 0 }}>
              Challenge completed! Achievement unlocked: PR submitted 🎉
            </p>
          )}
          <p></p>
        </div>
